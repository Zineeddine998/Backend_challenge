...
const UserSchema = new mongoose.Schema({
    ...
    password: {
        ...
        minlength: 6, //For more security, it is recommended to use a 
        // longer password minimum length or
        //  use implement other procedure like two-phases authentication,
        // for testing purposes it will be left at 6 here
        select: false
    },
